import { options } from "@/app/data/FooterLinks";
			...
			<div className="max-w-[1536px] mx-auto text-start h-full w-full grid grid-cols-[2fr_1fr_1fr_1fr] gap-x-5 grid-rows-1">
				...
				<div className="text-white font-vt323 h-full w-full flex flex-col justify-evenly">
					...
					<ul>
						...
						<li className="text-base lg:text-lg xl:text-xl hover:underline">
							<Link href="https://quest.cyobot.com/" target="_blank">
								Dashboard
							</Link>
						</li>
						<li className="text-base lg:text-lg xl:text-xl hover:underline">
							<Link href="https://www.roboticsquest.com/" target="_blank">
								RoboticsQuest
							</Link>
						</li>
					</ul>
				...
				<div className="text-white font-vt323 h-full w-full flex flex-col justify-evenly">
					...
					<ul>
						<li className="text-base lg:text-lg xl:text-xl hover:underline">
							<Link href="https://wiki.cyobot.com" target="_blank">
								Wiki
							</Link>
						</li>
						<li className="text-base lg:text-lg xl:text-xl hover:underline">
							<Link
								href="https://www.kickstarter.com/projects/cyobot/cyobot-a-transformable-quadruped-robot-for-innovation-and-fun?ref=discovery&term=CYOBot&total_hits=2&category_id=338"
								target="_blank"
							>
								Kickstarter
							</Link>
