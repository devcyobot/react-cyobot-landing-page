...
export const productsLinks: { link: string; title: string }[] = [
	{
		title: "CYOCrawler",
		link: "https://cyobot.myshopify.com/products/cyocrawler",
	},
	{
		title: "CYOBrain Builder Kit",
		link: "https://cyobot.myshopify.com/products/cyobot-main-board-esp32-microcontroller",
	},
	{
		title: "Dashboard",
